...
storage.chunks_dir_full(phase_4_1_config_hash, chunk_config_hash)   # Task 4.2 - full-corpus
                                                              # production chunk output, keyed by
                                                              # BOTH identities so it can never
                                                              # collide with chunks_dir()'s existing
