...
METRIC_DEFINITIONS: tuple[MetricDefinition, ...] = (
    ...
    MetricDefinition(
        ...
        {"k": 10}, implemented=False, available_for_current_gold=False,
    ),
    MetricDefinition(
    ...
    MetricDefinition(
        ...
        "Normalized discounted cumulative gain over document-level relevance in the top-10 retrieved results.",
        True, "document-level gold (Task 1.9 smoke set)", ("numeric", "comparative", "narrative", "unanswerable"),
        {"k": 10}, implemented=False, available_for_current_gold=True,
    ),
    MetricDefinition(
        "numeric_exact_match", "1.0", "answer",
        "Exact match between the system's predicted numeric value/unit and the Task 2.3 gold expected_value/expected_unit.",
    ...
    MetricDefinition(
        ...
        True, "Task 2.3 numeric/comparative gold", ("numeric", "comparative"),
        {"relative_tolerance": 0.01}, implemented=False, available_for_current_gold=True,
    ),
    MetricDefinition(
