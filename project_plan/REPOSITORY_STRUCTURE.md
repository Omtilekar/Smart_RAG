...
│   ├── guards/          # IMPLEMENTED (partial, Tasks 4.7-4.8) — input.py: deterministic
...
│   │                     # into src.generation.minimal; output guardrails still
│   │                     # planned (Phase 4.9)
